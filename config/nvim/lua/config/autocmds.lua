...
vim.api.nvim_create_autocmd("LspAttach", {
  callback = function(ev)
    ...
    vim.keymap.set("n", "gd", vim.lsp.buf.definition, tbl("Goto Definition"))
    vim.keymap.set("n", "gD", vim.lsp.buf.declaration, tbl("Goto Declaration"))
    vim.keymap.set("n", "gy", vim.lsp.buf.type_definition, tbl("Goto Type Definition"))
    vim.keymap.set("n", "gr", vim.lsp.buf.references, tbl("Goto References"))
